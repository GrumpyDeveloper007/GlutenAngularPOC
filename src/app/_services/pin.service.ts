...
export class PinService {
    ...
    private images = [
        // Generic labels -
        { fileName: "Store.png", search: "Store" },
        { fileName: "Store.png", search: "Shop" },
        { fileName: "SobaNoodle.png", search: "Noodle" },
        { fileName: "SobaNoodle.png", search: "Soba Noodle" },

        { fileName: "Bakso.png", search: "bakso" },
        // Country/regions
        { fileName: "Kerala.png", search: "Kerala" },
        { fileName: "Jamaican.png", search: "Jamaican" },
        { fileName: "Georgian.png", search: "Georgian" },
        { fileName: "Californian.png", search: "Californian" },
        ...
        { fileName: "Pan-Latin.png", search: "Nuevo Latino restaurant" },
        ...
        { fileName: "Taiwanese.png", search: "Taiwan Restaurant" },
        ...
        { fileName: "Belgian.png", search: "Frituur" },
        ...
        { fileName: "Chinese.png", search: "Hakka Restaurant" },
        { fileName: "Chinese.png", search: "Shanghainese restaurant" },
        ...
        { fileName: "Hungarian.png", search: "Hungarian" },
        { fileName: "Lithuanian.png", search: "Lithuanian" },
        { fileName: "Czech.png", search: "Czech" },
        { fileName: "Valencian.png", search: "Valencian" },
        { fileName: "Cuban.png", search: "Cuban" },
        { fileName: "Creole.png", search: "Creole" },
        { fileName: "Haitian.png", search: "Haitian" },
        { fileName: "PuertoRican.png", search: "Puerto Rican" },
        { fileName: "Guatemalan.png", search: "Guatemalan" },
        { fileName: "Brazilian.png", search: "Brazilian" },
        { fileName: "Brazilian.png", search: "Minas Gerais restaurant" },
        { fileName: "Tunisian.png", search: "Tunisian" },
        { fileName: "Dominican.png", search: "Dominican" },
        { fileName: "NewEngland.png", search: "New England" },
        { fileName: "Uyghur.png", search: "Uyghur" },
        { fileName: "Persian.png", search: "Persian" },
        { fileName: "MiddleEastern.png", search: "middle eastern" },
        { fileName: "MiddleEastern.png", search: "Shawarma restaurant" },
        { fileName: "Afghan.png", search: "Afghan" },
        { fileName: "Portuguese.png", search: "Portuguese" },
        { fileName: "Portuguese.png", search: "Fado restaurant" },
        { fileName: "Cantonese.png", search: "Cantonese" },
        { fileName: "African.png", search: "African" },
        { fileName: "Filipino.png", search: "Filipino" },
        { fileName: "Provence.png", search: "Provence" },
        { fileName: "PacificNorthwest.png", search: "Pacific Northwest" },
        { fileName: "Basque.png", search: "Basque" },
        { fileName: "Bavarian.png", search: "Bavarian" },
        { fileName: "Bavarian.png", search: "Franconian restaurant" },
        { fileName: "Sardinian.png", search: "Sardinian" },
        { fileName: "Venetian.png", search: "Venetian" },
        { fileName: "Asturian.png", search: "Asturian" },
        { fileName: "Alsace.png", search: "Alsace" },
        { fileName: "Arab.png", search: "Arab restaurant" },
        { fileName: "Australian.png", search: "Australian" },
        { fileName: "Kiwi.png", search: "New Zealand" },
        { fileName: "Kiwi.png", search: "Tegal" },

        { fileName: "Upscale.png", search: "Upscale" },
        { fileName: "SugarShack.png", search: "Sugar Shack" },
        { fileName: "Cajun.png", search: "Cajun" },
        { fileName: "Eatery.png", search: "Eatery" },
        { fileName: "Eclectic.png", search: "Eclectic" },
        { fileName: "Monjayaki.png", search: "Monjayaki" },
        { fileName: "Yakatabune.png", search: "Yakatabune" },
        { fileName: "Tongue.png", search: "Tongue" },
        { fileName: "Tofu.png", search: "Tofu" },
        { fileName: "Inn.png", search: "Inn" },
        ...
        { fileName: "Casino.png", search: "Cazinou" },
        ...
        { fileName: "Porridge.png", search: "Porridge" },
        { fileName: "CreativeCuisine.png", search: "Creative cuisine" },
        ...
        { fileName: "Market.png", search: "Produce wholesaler" },
        { fileName: "Market.png", search: "Vegetable wholesaler" },
        ...
        { fileName: "Supermarket.png", search: "Food store" },
        { fileName: "Supermarket.png", search: "Health food shop" },
        ...
        { fileName: "ColdCutStore.png", search: "Cold cut store" },
        { fileName: "BrewingStore.png", search: "Brewing supply store" },
        { fileName: "DairyStore.png", search: "Dairy store" },
        { fileName: "PretzelStore.png", search: "Pretzel store" },
        { fileName: "HamStore.png", search: "Ham store" },
        { fileName: "HamStore.png", search: "Ham shop" },
        ...
        { fileName: "Stadium.png", search: "Events Venue" },
        ...
        { fileName: "SCUBA.png", search: "SCUBA" },
        ...
        { fileName: "Temple.png", search: "Gurudwara" },
    ...
    isStore(restaurantType: string): boolean {
        return restaurantType != null && (restaurantType.includes("store")
            ...
            || restaurantType == "Health food shop"
            || restaurantType == "Natural Foods Shop"
            || restaurantType == "Butcher shop"
            || restaurantType == "Confectionery Store"
            || restaurantType == "Japanese confectionery shop"
            || restaurantType == "Butcher shop deli"
            || restaurantType == "Organic Food Shop"
            || restaurantType == "Fruit and vegetable wholesaler"
            || restaurantType == "Butchers"
        );
    }
    ...
    getUrlForGeneric(restaurantName: string): string | null {
        ...
        if (restaurantName.toLowerCase().includes("Desserts")) {
